...
-   Map is an example of a functional: a function that accepts other functions as input and returns a vector as output.
    ...
    -   To use a map function:
        ...
        -   In other words, purrr functions assist in breaking down a complex problem into small steps. It is also possible to compose data analysis steps using pipes
