...
Can change the above function to accept data.frames

introduce the map functions and different versions of maps, use it on a data frame

idea of anonymous functions
